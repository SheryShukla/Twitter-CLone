...
import { Avatar,Divider, Button, IconButton, ListItemIcon, Menu, MenuItem } from "@mui/material";
import DoneIcon from '@mui/icons-material/Done';
//import { CustomeLink } from "react-router-dom";
...
const Sidebar = ({handleLogout, user}) => {
    ...
    return(
        <div className="sidebar">
            <img className='sidebar_twitterIcon' src={ticon} alt='t1'/>
            ...
            <div className="profile-info">
                ...
                <Menu id="basic-menu" anchorEl={anchorE1} open={openMenu} onClick={handleClose} onClose={handleClose}>
                    ...
                    <MenuItem onClick={handleLogout}>Log out @gojo</MenuItem>
                </Menu>
           </div>
